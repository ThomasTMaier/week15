...
public class GlobalControllerErrorHandler {
	...
	public ExceptionMessage handleNoSuchElementException(NoSuchElementException exc, WebRequest webRequest) {
		return buildExceptionMessage(exc, HttpStatus.NOT_FOUND, webRequest, LogStatus.MESSAGE_ONLY);
	}
	private ExceptionMessage buildExceptionMessage(NoSuchElementException exc, HttpStatus status,
		...
		if(logStatus == LogStatus.MESSAGE_ONLY) {
			log.error("Exeption : ()", exc.toString());
